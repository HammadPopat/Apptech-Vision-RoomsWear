...
include 'navbar.php';
 ...
 <div class="col-md-5">
 <img src="ext/img/table1.jpg" width="98%" height="70%" id="img1">
 </div>
 <div class="col-md-6">
     <h4>Customization</h4>
     <!-- 
 ...
 <script type="text/javascript">
     ...
     function one1(){
         document.getElementById('img1').setAttribute("src","ext/img/table1.jpg");
     }
     function sec(){
         document.getElementById('img1').setAttribute("src","ext/img/sofachair1.jpg");
     }
     function main(){
