<?php   
   ...
   <div class="col-md-5">
   <img src="ext/img/chair1/chair 2.png" width="98%" height="70%" id="img1">
   </div>
   <div class="col-md-6">
       <h4>Customization</h4>
       <!-- 
   ...
   <script type="text/javascript">
       ...
       function one1(){
           document.getElementById('img1').setAttribute("src","ext/img/chair1/chair 3.png");
       }
       function sec(){
           document.getElementById('img1').setAttribute("src","ext/img/chair1/chiar005.png");
       }
       function main(){
           document.getElementById('img1').setAttribute("src","");
       }
       function third(){
           document.getElementById('img1').setAttribute("src","ext/img/chair1/chair 002.png");
       }
       function one4(){
           document.getElementById('img1').setAttribute("src","ext/img/chair1/chair 2.png");
       }
