  ...
  <?php   
   ...
   <div class="col-md-5">
   <img src="ext/img/livingroom/living room decor.PNG" width="98%" height="70%" id="img1">
   </div>
   <div class="col-md-6">
       <h4>Customization</h4>
       <!-- 
   ...
   <script type="text/javascript">
       ...
       function one1(){
           document.getElementById('img1').setAttribute("src","ext/img/livingroom/living room decor.PNG");
       }
       function sec(){
           document.getElementById('img1').setAttribute("src","ext/img/livingroom/living room decor2.PNG");
       }
       function main(){
           document.getElementById('img1').setAttribute("src","ext/img/livingroom/living room decor3.PNG");
       }
       function third(){
           document.getElementById('img1').setAttribute("src","ext/img/livingroom/living room decor.PNG");
       }
       function one4(){
           document.getElementById('img1').setAttribute("src","ext/img/sofa1.jpg");
       }
