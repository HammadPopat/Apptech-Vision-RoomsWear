          ...
          <div class="slides-1 portfolio-details-slider swiper">
            <div class="swiper-wrapper align-items-center">
              ...
              <div class="swiper-slide">
                <img src="ext/img/portfolio/app-1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="ext/img/portfolio/product-1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="ext/img/portfolio/branding-1.jpg" alt="">
              </div>

              <div class="swiper-slide">
                <img src="ext/img/portfolio/books-1.jpg" alt="">
              </div>
          ...
          <div class="col-lg-8">
            <div class="portfolio-description">
              ...
              <div class="testimonial-item">
                ...
                <div>
                  <img src="ext/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
                  <h3>Sara Wilsson</h3>
                  <h4>Designer</h4>
                </div>
              </div>
